    ...
    <div class="main-content by-goods-create padding-md-bottom padding-md-top">
        ...
        <el-row v-if="active == 0" type="flex" justify="center">
            <el-col :span="24" class="margin-md-top">
                ...
                <el-alert type="warning">一个商品只能关联一个类目, 选择后不能再变更，如果以下没有，请到类目中添加</el-alert>
            ...
            <div v-for="(prop, index) in cateProperties" :key="prop.id">
                <div class="cate-prop-item margin-md-top">
                    ...
                    <div class="cate-prop-values">
                        <el-select size="mini" v-if="prop.prop_type === 'single'" v-model="selectedPropValueIds[index]"
                                   clearable
                                   placeholder="请选择">
                            <el-option
                        ...
                        <el-select size="mini" v-if="prop.prop_type === 'multiple'" multiple
        ...
        >
            ...
            <el-form-item
                    :label="$t('Price')"
                    prop="show_price">
                <el-input type="number" size="mini" class="number-input" v-model="addForm.show_price"/>
                {{$t('Yuan')}}
            </el-form-item>
            <el-form-item
                    :label="$t('Weight')"

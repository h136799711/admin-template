<template>
    ...
    >
        <el-row class="padding-md">
          <el-col :span="6" class="margin-lg-bottom">
            <div class="text-center" style="margin: auto;width: 90px;">
              <el-button type="default" class="margin-sm-bottom" style="width: 80px;height: 80px;" circle>
                {{ newUsers }}
              </el-button>
              <span>新增用户</span>
            </div>
          ...
          <el-col :span="12">
            <div id="site_update" style="height: 240px;">
              <i v-if="requestSiteUpdateData" class="el-icon-loading " style="font-size: 36px;"></i>
            </div>
          </el-col>
          <el-col :span="12">
            <div id="video_update" style="height: 240px;">
              <i v-if="requestSiteUpdateData" class="el-icon-loading " style="font-size: 36px;"></i>
            </div>
          </el-col>
        </el-row>

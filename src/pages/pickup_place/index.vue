                        ...
                        <template slot-scope="scope">
                            <div>
                                <el-image
                                        ...
                                        :src="scope.row.thumbnail" alt="主图"  />
                            </div>
                        </template>
                    </el-table-column>
                    <el-table-column
        ...
        <div class="edit-form" v-if="this.dialogEditVisible">
            ...
            >
                <el-form-item
                        ...
                        required
                        prop="title">
                    <el-input maxlength="60" size="mini" show-word-limit v-model="editForm.title" placeholder="标题"/>
                </el-form-item>
                <el-form-item
                        :label="$t('Description')"
                        required
                        prop="description">
                    <el-input maxlength="60" size="mini" show-word-limit  v-model="editForm.description" placeholder="位置备注"/>
                </el-form-item>
                <el-form-item
                        :label="$t('Lng')"
                        required
                ...
                <el-form-item
                        ...
                        prop="thumbnail"
                >
                    <ImgUploader ref="editImgUploader" @onUploadSuccess="onUploadSuccess" :defaultImgUrl="editForm.thumbnail" :clear="imgUploadClear" imgType="pic"/>
                </el-form-item>
                <el-form-item
                        :label="$t('Location')"
                        required
                ...
                <el-form-item
                        ...
                        required
                        prop="phone" >
                    <el-input type="number" v-model="editForm.phone"/>
                </el-form-item>
                <el-form-item
                        :label="$t('BookingDays')"
                        required
                        prop="booking_days" >
                    <el-input type="number" v-model="editForm.booking_days"/>
                </el-form-item>
            </el-form>
        ...
        <div class="add-form" v-if="this.dialogAddVisible">
            ...
            >
                ...
                <el-form-item
                        ...
                        required
                        prop="description">
                    <el-input maxlength="60" size="mini" show-word-limit  v-model="addForm.description" placeholder="位置备注"/>
                </el-form-item>
                <el-form-item
                        :label="$t('Lng')"
                        required
                ...
                <el-form-item
                        ...
                        prop="thumbnail"
                >
                    <ImgUploader ref="addImgUploader" @onUploadSuccess="onUploadSuccess" :defaultImgUrl="addForm.thumbnail" :clear="imgUploadClear" imgType="pic"/>
                </el-form-item>
                <el-form-item
                        :label="$t('Location')"
                        required
                ...
                <el-form-item
                        ...
                        required
                        prop="phone" >
                    <el-input type="number" v-model="addForm.phone"/>
                </el-form-item>
                <el-form-item
                        :label="$t('BookingDays')"
                        required
                        prop="booking_days" >
                    <el-input type="number" v-model="addForm.booking_days"/>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">

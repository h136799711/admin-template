<template>
    <div class="main-content by-user-profile padding-md-bottom padding-md-top">
        ...
        <div class="grid-content margin-md-top">
            <el-form ref="form" :disabled="loading" :model="info" label-width="80px">
                ...
                <el-form-item>
                    <ImgUploader ref="imgUploader" @onUploadSuccess="onUploadSuccess" :defaultImgUrl="info.head"
                                 :clear="imgUploadClear" imgType="avatar"/>
                </el-form-item>
                <el-form-item>
                    <el-button
                            :loading="loading"

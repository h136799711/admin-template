...
<template>
    <div class="main-content by-user-session padding-md-bottom padding-md-top">
        ...
        <el-form :inline="true" v-if="!loading" v-model="editForm" class="">
            <el-form-item label="同时在线会话数">
                <el-input size="mini" v-model="editForm.limit" placeholder="同时在线会话数"></el-input>
            </el-form-item>
            <el-form-item>
                <el-popconfirm
                        icon="el-icon-danger"
                ...
                >
                    <el-button type="danger" size="mini" icon="el-icon-edit-outline" slot="reference">{{$t('Save')}}</el-button>
                </el-popconfirm>
            </el-form-item>
        </el-form>
            ...
            >
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        >
                            <el-button type="danger" size="mini" icon="el-icon-delete" slot="reference">{{$t('Delete')}}</el-button>
                        </el-popconfirm>
                    </template>
                </el-table-column>
            </el-table>

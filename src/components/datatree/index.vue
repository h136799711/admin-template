...
<template>
    <div class="main-content by-datatree padding-md-bottom padding-md-top">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item :to="{ path: '/admin/datatree/index' }">数据字典</el-breadcrumb-item>
            </el-breadcrumb>
        ...
        <el-alert
            ...
            <el-button-group>
                <el-tooltip placement="right">
                    <div slot="content">只刷新当前数据</div>
                    <el-button @click="refresh()" type="primary" size="small" >
                        <span class="by-icon by-shuaxin"></span>
                        刷新
                    </el-button>
                </el-tooltip>
            </el-button-group>
            ...
            <el-col :span="5">
                <div class="grid-content">
                    <h3 class="margin-sm-bottom">
                        <el-tooltip placement="right">
                            <div slot="content">加载一级数据字典</div>
                            <el-button type="text" @click="refresh()">根节点</el-button>
                        </el-tooltip>
                        <span class="">{{ '>>' + currentNodeName }}</span>
                    </h3>
                    <el-tree
                        class="filter-tree"
                ...
                <div class="grid-content margin-md-bottom">
                    <div class="margin-sm-bottom">
                        <div style="height: 33px;">
                            <el-button @click="datatreeAction('edit')" type='primary' icon='edit' size='mini'>编辑</el-button>
                            <el-button @click="datatreeAction('add')" type='primary' icon='plus' size='mini'>添加</el-button>
                            <el-button @click='datatreeBulkDelete' type='danger' icon='delete' size='mini'>选中项删除</el-button>
                        </div>
                    </div>
                    <el-table
                        ref="datatreeTable"
        ...
        <el-dialog :show-close="false" :modal-append-to-body="false" title="添加" :visible.sync="dialogAddVisible">
            <el-form :model="ruleForm" label-position="right" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="排序" prop="sort">
                    <el-input-number :min='1'  :max="99999999" v-model="ruleForm.sort"></el-input-number>
                </el-form-item>
                <el-form-item label="级别" prop="data_level">
                    <el-radio-group v-model="ruleForm.data_level" >
                        <el-radio name="data_level" label="0">一般数据</el-radio>
                        <el-radio name="data_level" label="1">系统数据</el-radio>
                    </el-radio-group>
                </el-form-item>
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button @click="submitDatatreeForm('ruleForm')" type="primary">确 定</el-button>
            </div>
        </el-dialog>
        <el-dialog :show-close="false" :modal-append-to-body="false" title="编辑" :visible.sync="dialogEditVisible">
            <el-form :model="editForm" label-position="right" :rules="rules" ref="editForm" label-width="100px" class="edit-form">
                <el-form-item label="节点名称" prop="name">
                ...
                <el-form-item label="排序" prop="sort">
                    <el-input-number :min='1'  :max="99999999" v-model="editForm.sort"></el-input-number>
                </el-form-item>
                <el-form-item label="级别" prop="data_level">
                ...
                <el-form-item label="" prop="id" class="hidden">
                    <el-input :disabled="true" class="hidden" v-model="editForm.id"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
                <el-button @click="dialogEditVisible = false">取 消</el-button>
                <el-button @click="submitDatatreeForm('editForm')" type="primary">确 定</el-button>
            </div>
        </el-dialog>
